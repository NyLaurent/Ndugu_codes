      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl font-bold text-[#0B1C39] mb-6">
            <span className="text-[#0066FF]">Collaborate</span> with Us. Impact the World.
          </h1>
          <p className="text-gray-600 text-lg mb-12">
            At Ndugu Codes, we believe in the power of collaboration to drive change—not just in Africa, but across the globe. Whether you&apos;re a Web3 company, university, tech hub, or nonprofit, we welcome you to join us in shaping the future of decentralized innovation.
          </p>
