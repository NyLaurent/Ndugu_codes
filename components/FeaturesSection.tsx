  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-10 sm:mb-14 lg:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-14 lg:mb-16">
          <div className="text-center">
            <div className="bg-[#EEF5FF] w-12 h-12 sm:w-16 sm:h-16 rounded-lg flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <svg
                className="w-6 h-6 sm:w-8 sm:h-8 text-[#0066FF]"
        ...
        <div className="text-center">
          <h3 className="text-xl sm:text-2xl text-black font-bold mb-3 sm:mb-4">
          ...
          <Link
            href="/join-community"
            className="inline-flex items-center bg-[#0066FF] text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base"
          >
