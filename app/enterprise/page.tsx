  ...
  const partnershipOptions = [
    {
      ...
      description: "Get first access to our top graduates trained in blockchain development, smart contracts, and Web3 technologies.",
      icon: "",
      benefits: [
    ...
    },
    {
      ...
      description: "Transform your existing team with customized Web3 training programs tailored to your business needs.",
      icon: "",
      benefits: [
    ...
    {
      title: "Strategic R&D",
      description: "Collaborate on blockchain solutions with our developers and researchers to solve your business challenges.",
      icon: "",
      benefits: [
      ...
      <section id="contact" className="bg-white rounded-2xl p-8 sm:p-12 shadow-sm border border-gray-100">
        ...
        <form className="text-slate-500 grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="needs" className="block text-sm font-medium text-gray-700 mb-1">How can we help?</label>
            <select
              id="needs"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-[#0066FF] focus:border-[#0066FF]"
            >
