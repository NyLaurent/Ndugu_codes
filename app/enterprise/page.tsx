  ...
  const partnershipOptions = [
    {
      ...
      icon: "🎯",
      benefits: ["Pre-vetted candidates", "Custom training tracks", "90-day placement guarantee"],
    },
    {
      ...
      icon: "📚",
      benefits: ["Personalized curriculum", "Project-based learning", "Certification programs"],
    },
    {
      title: "Strategic R&D",
      description:
      ...
      icon: "🔬",
      benefits: ["Dedicated innovation lab", "Proof-of-concept development", "White-label solutions"],
    },
  ]
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      <div className="text-center mb-16 lg:mb-20">
        ...
        >
          Web3 Talent <span className="text-[#0066FF]">Solutions</span> for Enterprises
        </motion.h1>
        <motion.p
        ...
        >
          Bridge the blockchain skills gap and accelerate your Web3 initiatives with Africa&apos;s premier developer
          training hub
        </motion.p>
      </div>

      <section className="mb-20">
        <h2 className="text-2xl sm:text-3xl font-bold text-[#0B1C39] mb-8 text-center">Partnership Models</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {partnershipOptions.map((option, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[#0B1C39] mb-3">{option.title}</h3>
      ...
      <section className="bg-gradient-to-r from-[#0066FF]/5 to-[#0047CC]/5 rounded-2xl p-8 sm:p-12 mb-20">
        <h2 className="text-2xl sm:text-3xl font-bold text-[#0B1C39] mb-8 text-center">Proven Enterprise Impact</h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
          {successMetrics.map((metric, index) => (
            ...
            >
              <p className="text-3xl sm:text-4xl font-bold text-[#0066FF] mb-2">{metric.value}</p>
              <p className="text-sm sm:text-base text-gray-600">{metric.label}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-20">
        <h2 className="text-2xl sm:text-3xl font-bold text-[#0B1C39] mb-8 text-center">Enterprise Case Studies</h2>
        <div className="bg-white rounded-2xl overflow-hidden border border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 sm:p-12">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#0B1C39] mb-4">Scaling Engineering Capacity 3x</h3>
              <p className="text-gray-600 mb-6">
                &quot;Web3 Mates provided us with a pipeline of pre-vetted blockchain security specialists that reduced
                our hiring time by 70% and allowed us to take on 40% more clients within the first year.&quot;
              </p>
