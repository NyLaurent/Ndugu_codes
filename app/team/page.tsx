...
const team = [
  {
    ...
    description: "Drives the company's mission and strategic growth, inspiring innovation and fostering a culture of excellence.",
    socials: {
  ...
  },
  {
    ...
    description: "Ensures operational efficiency and seamless execution of projects, optimizing workflows to maximize impact.",
    socials: {
  ...
  },
  {
    ...
    description: "Leads technical support and blockchain development, ensuring robust, scalable solutions and expert troubleshooting.",
    socials: {
  ...
  },
  {
    ...
    description: "Builds and nurtures the developer community through technical guidance and ecosystem collaboration.",
    socials: {
          ...
          >
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="w-full sm:w-2/3 p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#0B1C39] mb-1">
                  {member.name}
                </h3>
                <p className="text-[#0066FF] mb-3 text-sm sm:text-base">
                  {member.role}
                </p>
